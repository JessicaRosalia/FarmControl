...
public class MamiferoDAO {
	 ...
	 * @author equipe
	 * @return List<Vacina> - uma lista com todas os Mamiferos do Banco de Dados.
	 */
     ...
     *  no Banco de Dados, se houver, Mamifero(s) que possuem o tipo correspondente ao passado como parâmetro,
